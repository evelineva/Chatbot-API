...
const masterOnly = require("../middleware/masterOnly");
const bcrypt = require("bcryptjs")

// GET all users
router.get("/", masterOnly, async (req, res) => {
...
router.put("/:id", masterOnly, async (req, res) => {
    const { email, npk, password, role, verified } = req.body;
...
// DELETE: Hapus user
router.delete("/:id", masterOnly, async (req, res) => {
